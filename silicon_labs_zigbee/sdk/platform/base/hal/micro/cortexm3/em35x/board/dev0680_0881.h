/** @file hal/micro/cortexm3/em35x/board/dev0680_0881.h
 ...
 *
 * @note The file dev0680_0881.h is intended to be copied, renamed, and
 * customized for customer-specific hardware.
 *
 * The file dev0680_0881.h is the default BOARD_HEADER file used with the breakout
 * board of the development kit.
 *
 * The EM35x on a dev0680_0881 BoB has the following example GPIO configuration.
 ...
 *
 * This board header (dev0680_0881) is not supported in framework NCP applications.
 ...
 *
 * \b Note: LED 2 is on the breakout board (dev0680_0881).
 *
...
/** @brief Configuration of GPIO for default antenna selection
 */
#ifdef ANTENNA_nSELECT_GPIO
#define PWRUP_OUT_ANT_SEL   1
#define PWRUP_OUT_ANT_nSEL  (PWRUP_OUT_ANT_SEL) ^ 1
#else
#define PWRUP_OUT_ANT_SEL   0
#define PWRUP_OUT_ANT_nSEL  1
#endif
...
/**
 * @brief This define does not equate to anything.  It is used as a
 * trigger to enable Packet Trace support on the breakout board (dev0680_0881).
 */
 ...
 * into the Breakout board (dev0680_0881).
