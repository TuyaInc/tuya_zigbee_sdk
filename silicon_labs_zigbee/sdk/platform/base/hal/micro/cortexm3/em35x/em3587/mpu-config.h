/** @file hal/micro/cortexm3/em35x/em3587/mpu-config.h
 *
 * @brief MPU configuration for the em3587
 *
...
#ifndef __EM3587_MPU_CFG_H__
#define __EM3587_MPU_CFG_H__
...
#define SRAM_REGION_ATTR     MATTR(1, PRW_URW, MEM_NORMAL, 0x00, SIZE_64K, 1)
