/** @file hal/micro/cortexm3/em35x/board/ncp_uart_em359x.h
...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                                    \
  uint16_t gpioCfgPowerUp[9] = {                                               \
    ...
    ((GPIOCFG_UNUSED     << PD0_CFG_BIT)                                       \
     | (GPIOCFG_OUT        << PD1_CFG_BIT)                       /* SC3TXD  */ \
     | (GPIOCFG_OUT        << PD2_CFG_BIT)                       /* SC3RXD  */ \
     | (GPIOCFG_OUT        << PD3_CFG_BIT)),                     /* SC3nCTS */ \
    ((GPIOCFG_OUT        << PD4_CFG_BIT)                         /* SC3nRTS */ \
     | (GPIOCFG_UNUSED     << PD5_CFG_BIT)                                     \
     | (GPIOCFG_UNUSED     << PD6_CFG_BIT)                                     \
     | (GPIOCFG_UNUSED     << PD7_CFG_BIT)),                                   \
    ((GPIOCFG_OUT        << PE0_CFG_BIT)                                       \
     | (GPIOCFG_OUT        << PE1_CFG_BIT)                                     \
     | (GPIOCFG_OUT        << PE2_CFG_BIT)                                     \
