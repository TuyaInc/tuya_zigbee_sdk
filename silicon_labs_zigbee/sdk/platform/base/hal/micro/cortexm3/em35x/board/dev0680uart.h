/** @file hal/micro/cortexm3/em35x/board/dev0680uart.h
 ...
 *
 * The file dev0680uart.h is the BOARD_HEADER file used with the breakout
 * board of the development kit for use with EZSP-UART.
 *
