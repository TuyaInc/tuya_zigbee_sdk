/** @file hal/micro/cortexm3/em35x/em3591/wake-gpio.h
 *
 * @brief
...
#define EMBER_WAKE_PORT_A                  \
  ((WAKE_ON_PA0 << _GPIO_P_IN_Px0_SHIFT)   \
   ...
   | (WAKE_ON_PA6 << _GPIO_P_IN_Px6_SHIFT) \
...
#define EMBER_WAKE_PORT_B                  \
  ((WAKE_ON_PB0 << _GPIO_P_IN_Px0_SHIFT)   \
   ...
   | (WAKE_ON_PB5 << _GPIO_P_IN_Px5_SHIFT) \
   | (WAKE_ON_PB6 << _GPIO_P_IN_Px6_SHIFT) \
...
#define EMBER_WAKE_PORT_D                  \
  ((WAKE_ON_PD1 << _GPIO_P_IN_Px1_SHIFT)   \
   | (WAKE_ON_PD2 << _GPIO_P_IN_Px2_SHIFT) \
   | (WAKE_ON_PD3 << _GPIO_P_IN_Px3_SHIFT) \
   | (WAKE_ON_PD4 << _GPIO_P_IN_Px4_SHIFT) \
  )

#define EMBER_WAKE_PORT_E                  \
  ((WAKE_ON_PE0 << _GPIO_P_IN_Px0_SHIFT)   \
   | (WAKE_ON_PE1 << _GPIO_P_IN_Px1_SHIFT) \
   | (WAKE_ON_PE2 << _GPIO_P_IN_Px2_SHIFT) \
   | (WAKE_ON_PE3 << _GPIO_P_IN_Px3_SHIFT) \
  )
