/** @file hal/micro/cortexm3/em35x/board/dev0680_20gpio.h
 ...
 *
 * @note The file dev0680_20gpio.h is intended to be copied, renamed, and
 * customized for customer-specific hardware.
 *
 * A 20 GPIO EM35x variant on a dev0680 BoB has the following example GPIO config.
 ...
 * 20 GPIO variants do not have PB7, which is usually used for this purpose on
...
//for the unused pins on the 20-gpio variants, so the cfg arrays need to be 6
//entries of 16bits.
