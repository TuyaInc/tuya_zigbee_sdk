/** @file hal/micro/cortexm3/em35x/board/dev0680_16gpio.h
 ...
 *
 * @note The file dev0680_16gpio.h is intended to be copied, renamed, and
 * customized for customer-specific hardware.
 *
 * A 16 GPIO EM35x variant on a dev0680 BoB has the following example GPIO config.
 ...
 * - PC7 - TEMP_EN / Data flash enable (must be connected manually)
 *
 *@{
 */
...
#ifdef RADIO_HOLDOFF
  #error Radio HoldOff not supported with a 16-gpio variant on a dev0680
#endif
 ...
 * 16 GPIO variants do not have PB7, which is usually used for this purpose on
 * dev0680 board. PC7 has been selected as an alternate, please connect PC7 to
 * the enable line when using shutdown control.
 */
#ifdef EEPROM_USES_SHUTDOWN_CONTROL
  #define EEPROM_POWER_PORT_PIN PORTC_PIN(7)
#endif
 ...
 * Button1 and TEMP_EN / data flash enable.
 *@{
 */
 ...
 */
  ...
  #define OUT_TEMPEN         0 /* Defaults off */
#endif//ENABLE_OSC32K
...
/**
 * @brief 16 GPIO EM3xx variants do not have USB, however this define is
 * required to stop the compiler from complaining
 */
#define halInternalSuspendBoard() (void)0

/**
 * @brief 16 GPIO EM3xx variants do not have USB, however this define is
 * required to stop the compiler from complaining
 */
#define halInternalResumeBoard() (void)0
