...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(16,DMA_IRQHandler,DMA_IRQn,DMA_IRQHandler,4,0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(19,halReserved19Isr, (IRQn_Type)(19-16),halReserved19Isr,4,0)
    //EXCEPTION(19,USART0_RX_IRQHandler,USART0_RX_IRQn,USART0_RX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(20,halReserved20Isr, (IRQn_Type)(20-16),halReserved20Isr,4,0)
    //EXCEPTION(20,USART0_TX_IRQHandler,USART0_TX_IRQn,USART0_TX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(21,USB_IRQHandler,USB_IRQn,USB_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(22,ACMP0_IRQHandler,ACMP0_IRQn,ACMP0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(23,ADC0_IRQHandler,ADC0_IRQn,ADC0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(24,DAC0_IRQHandler,DAC0_IRQn,DAC0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(25,I2C0_IRQHandler,I2C0_IRQn,I2C0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(26,I2C1_IRQHandler,I2C1_IRQn,I2C1_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(27,GPIO_ODD_IRQHandler,GPIO_ODD_IRQn,GPIO_ODD_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(28,TIMER1_IRQHandler,TIMER1_IRQn,TIMER1_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(29,TIMER2_IRQHandler,TIMER2_IRQn,TIMER2_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(30,TIMER3_IRQHandler,TIMER3_IRQn,TIMER3_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(31,USART1_RX_IRQHandler,USART1_RX_IRQn,USART1_RX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(32,USART1_TX_IRQHandler,USART1_TX_IRQn,USART1_TX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(33,LESENSE_IRQHandler,LESENSE_IRQn,LESENSE_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(34,USART2_RX_IRQHandler,USART2_RX_IRQn,USART2_RX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(35,USART2_TX_IRQHandler,USART2_TX_IRQn,USART2_TX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(36,UART0_RX_IRQHandler,UART0_RX_IRQn,UART0_RX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(37,UART0_TX_IRQHandler,UART0_TX_IRQn,UART0_TX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(38,UART1_RX_IRQHandler,UART1_RX_IRQn,UART1_RX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(39,UART1_TX_IRQHandler,UART1_TX_IRQn,UART1_TX_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(40,LEUART0_IRQHandler,LEUART0_IRQn,LEUART0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(41,LEUART1_IRQHandler,LEUART1_IRQn,LEUART1_IRQHandler,4,0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(43,PCNT0_IRQHandler,PCNT0_IRQn,PCNT0_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(44,PCNT1_IRQHandler,PCNT1_IRQn,PCNT1_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(45,PCNT2_IRQHandler,PCNT2_IRQn,PCNT2_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(46,RTC_IRQHandler,RTC_IRQn,RTC_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(47,BURTC_IRQHandler,BURTC_IRQn,BURTC_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(48,CMU_IRQHandler,CMU_IRQn,CMU_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(49,VCMP_IRQHandler,VCMP_IRQn,VCMP_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(50,halReserved50Isr, (IRQn_Type)(50-16),halReserved50Isr,4,0)
    //EXCEPTION(50,LCD_IRQHandler,LCD_IRQn,LCD_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(51,MSC_IRQHandler,MSC_IRQn,MSC_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(52,AES_IRQHandler,AES_IRQn,AES_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(53,halReserved53Isr, (IRQn_Type)(53-16),halReserved53Isr,4,0)
    //EXCEPTION(53,EBI_IRQHandler,EBI_IRQn,EBI_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(54,EMU_IRQHandler,EMU_IRQn,EMU_IRQHandler,4,0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(55,halReserved55Isr,(IRQn_Type)(55-16),halReserved55Isr,1,0)
    //EXCEPTION(55,FPUEH_IRQHandler,FPUEH_IRQn,FPUEH_IRQHandler,1,0)
/* *INDENT-ON**/
#undef SEGMENT
#undef SEGMENT2
