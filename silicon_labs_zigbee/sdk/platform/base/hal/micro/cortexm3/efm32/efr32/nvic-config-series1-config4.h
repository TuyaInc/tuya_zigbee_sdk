...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54,      VDAC0_IRQHandler,            VDAC0_IRQn,      VDAC0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55,    LESENSE_IRQHandler,          LESENSE_IRQn,    LESENSE_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56,      TRNG0_IRQHandler,            TRNG0_IRQn,      TRNG0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57,      halReserved57Isr,    (IRQn_Type)(57-16),      halReserved57Isr,     NVIC_NONE, NVIC_NONE)
