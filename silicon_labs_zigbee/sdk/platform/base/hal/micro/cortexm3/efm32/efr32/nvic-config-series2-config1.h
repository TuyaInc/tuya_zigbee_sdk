...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     16,   SETAMPERHOST_IRQHandler,        (IRQn_Type)(0),   SETAMPERHOST_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     17,         SEMBRX_IRQHandler,        (IRQn_Type)(1),         SEMBRX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     18,         SEMBTX_IRQHandler,        (IRQn_Type)(2),         SEMBTX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     19,     SMU_SECURE_IRQHandler,       SMU_SECURE_IRQn,     SMU_SECURE_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     20, SMU_PRIVILEGED_IRQHandler,   SMU_PRIVILEGED_IRQn, SMU_PRIVILEGED_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     21,            EMU_IRQHandler,              EMU_IRQn,            EMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     22,         TIMER0_IRQHandler,           TIMER0_IRQn,         TIMER0_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     24,         TIMER2_IRQHandler,           TIMER2_IRQn,         TIMER2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     25,         TIMER3_IRQHandler,           TIMER3_IRQn,         TIMER3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     26,           RTCC_IRQHandler,             RTCC_IRQn,           RTCC_IRQHandler,             4,         0)
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     29,      USART1_RX_IRQHandler,        USART1_RX_IRQn,      USART1_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     30,      USART1_TX_IRQHandler,        USART1_TX_IRQn,      USART1_TX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     31,      USART2_RX_IRQHandler,        USART2_RX_IRQn,      USART2_RX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     32,      USART2_TX_IRQHandler,        USART2_TX_IRQn,      USART2_TX_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     33,        ICACHE0_IRQHandler,          ICACHE0_IRQn,        ICACHE0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     34,          BURTC_IRQHandler,            BURTC_IRQn,          BURTC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     35,        LETIMER_IRQHandler,         LETIMER0_IRQn,       LETIMER0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     36,         SYSCFG_IRQHandler,           SYSCFG_IRQn,         SYSCFG_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     37,           LDMA_IRQHandler,             LDMA_IRQn,           LDMA_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     38,           LFXO_IRQHandler,             LFXO_IRQn,           LFXO_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     39,          LFRCO_IRQHandler,            LFRCO_IRQn,          LFRCO_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     40,         ULFRCO_IRQHandler,           ULFRCO_IRQn,         ULFRCO_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     41,       GPIO_ODD_IRQHandler,         GPIO_ODD_IRQn,       GPIO_ODD_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     42,      GPIO_EVEN_IRQHandler,        GPIO_EVEN_IRQn,      GPIO_EVEN_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     43,           I2C0_IRQHandler,             I2C0_IRQn,           I2C0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     44,           I2C1_IRQHandler,             I2C1_IRQn,           I2C1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     45,          EMUDG_IRQHandler,            EMUDG_IRQn,          EMUDG_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     46,          EMUSE_IRQHandler,            EMUSE_IRQn,          EMUSE_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     47,            AGC_IRQHandler,              AGC_IRQn,            AGC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     48,           BUFC_IRQHandler,             BUFC_IRQn,           BUFC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     49,        FRC_PRI_IRQHandler,          FRC_PRI_IRQn,        FRC_PRI_IRQHandler,             3,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     50,            FRC_IRQHandler,              FRC_IRQn,            FRC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     51,          MODEM_IRQHandler,            MODEM_IRQn,          MODEM_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     52,       PROTIMER_IRQHandler,         PROTIMER_IRQn,       PROTIMER_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     53,        RAC_RSM_IRQHandler,          RAC_RSM_IRQn,        RAC_RSM_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54,        RAC_SEQ_IRQHandler,          RAC_SEQ_IRQn,        RAC_SEQ_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55,         PROTRC_IRQHandler,       (IRQn_Type)(39),         PRORTC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56,          SYNTH_IRQHandler,            SYNTH_IRQn,          SYNTH_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57,          ACMP0_IRQHandler,            ACMP0_IRQn,          ACMP0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     58,          ACMP1_IRQHandler,            ACMP1_IRQn,          ACMP1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     59,          WDOG0_IRQHandler,            WDOG0_IRQn,          WDOG0_IRQHandler,             1,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     60,          WDOG1_IRQHandler,            WDOG1_IRQn,          WDOG1_IRQHandler,             1,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     61,          HFXO00_IRQHandler,            HFXO00_IRQn,          HFXO00_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     62,         HFRCO0_IRQHandler,           HFRCO0_IRQn,         HFRCO0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     63,      HFRCOEM32_IRQHandler,        HFRCOEM23_IRQn,      HFRCOEM23_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     64,            CMU_IRQHandler,              CMU_IRQn,            CMU_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     65,            AES_IRQHandler,              AES_IRQn,            AES_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     66,           IADC_IRQHandler,             IADC_IRQn,           IADC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     67,            MSC_IRQHandler,              MSC_IRQn,            MSC_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     68,          DPLL0_IRQHandler,            DPLL0_IRQn,          DPLL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     69,            SW0_IRQHandler,              SW0_IRQn,            SW0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     70,            SW1_IRQHandler,              SW1_IRQn,            SW1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     71,            SW2_IRQHandler,              SW2_IRQn,            SW2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     72,            SW3_IRQHandler,              SW3_IRQn,            SW3_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     73,        KERNEL0_IRQHandler,          KERNEL0_IRQn,        KERNEL0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     74,        KERNEL1_IRQHandler,          KERNEL1_IRQn,        KERNEL1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     75,        M33CTI0_IRQHandler,          M33CTI0_IRQn,        M33CTI0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     76,        M33CTI1_IRQHandler,          M33CTI1_IRQn,        M33CTI1_IRQHandler,             4,         0)
