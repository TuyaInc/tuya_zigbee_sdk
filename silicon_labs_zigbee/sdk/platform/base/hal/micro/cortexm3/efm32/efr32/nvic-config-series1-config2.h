...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     46, RTCC_IRQHandler,RTCC_IRQn,RTCC_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     47, SYNTH_IRQHandler,SYNTH_IRQn,SYNTH_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     48, CRYOTIMER_IRQHandler,CRYOTIMER_IRQn,CRYOTIMER_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     49, RFSENSE_IRQHandler,RFSENSE_IRQn,RFSENSE_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     50, FPUEH_IRQHandler,FPUEH_IRQn,FPUEH_IRQHandler,             1,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     51, SMU_IRQHandler,SMU_IRQn,SMU_IRQHandler,               4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     52, WTIMER0_IRQHandler,WTIMER0_IRQn,WTIMER0_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     53, WTIMER1_IRQHandler,WTIMER1_IRQn,WTIMER1_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54, PCNT1_IRQHandler,PCNT1_IRQn,PCNT1_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55, PCNT2_IRQHandler,PCNT2_IRQn,PCNT2_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56, USART2_RX_IRQHandler,USART2_RX_IRQn,USART2_RX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57, USART2_TX_IRQHandler,USART2_TX_IRQn,USART2_TX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     58, I2C1_IRQHandler,I2C1_IRQn,I2C1_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     59, USART3_RX_IRQHandler,USART3_RX_IRQn,USART3_RX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     60, USART3_TX_IRQHandler,USART3_TX_IRQn,USART3_TX_IRQHandler,         4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     61, VDAC0_IRQHandler,VDAC0_IRQn,VDAC0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     62, CSEN_IRQHandler,CSEN_IRQn,CSEN_IRQHandler,              4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     63, LESENSE_IRQHandler,LESENSE_IRQn,LESENSE_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     64, CRYPTO1_IRQHandler,CRYPTO1_IRQn,CRYPTO1_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     65, TRNG0_IRQHandler,TRNG0_IRQn,TRNG0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     66, halReserved66Isr,(IRQn_Type)(66-16),halReserved66Isr,     NVIC_NONE, NVIC_NONE)
/* *INDENT-ON**/
