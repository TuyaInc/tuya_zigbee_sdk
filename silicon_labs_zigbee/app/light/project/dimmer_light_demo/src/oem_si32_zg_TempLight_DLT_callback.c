...
const dev_description_t g_dev_des[] = {
    { 1, ZHA_PROFILE_ID, ZG_DEVICE_ID_COLOR_DIMMABLE_LIGHT, SERVER_CLUSTER_LEN, (cluster_t *)&g_server_cluster_id[0], 0, NULL },
};
...
#define ZIGBEE_JOIN_MAX_TIMEOUT             180000//5min
        ...
        case KEY_1_ID: {
            ...
            if(key_st == KEY_ST_PUSH) {
                ...
                if(push_time < KEY_PUSH_TIME_FOR_ZIGBEE_JOIN_NEW) {
                  ...
                  //uint8_t Keystr[]="setbri00aabbcl\r\n";
                  //user_uart_send(UART_ID_UART0,Keystr, strlen(Keystr));
