 ...
 * @par email:
 *      zhangpeng@tuya.com
 * @file zigbee_raw_cmd_api.h
 * @brief This file defines the send function for some commands
...
#ifndef __ZIGBEE_RAW_CMD_API_H__
#define __ZIGBEE_RAW_CMD_API_H__
...
}app_outgoing_msg_type_t;

// This is generated client API
typedef struct {
    uint8_t source_endpoint;
    uint8_t dest_endpoint;
    app_outgoing_msg_type_t type;
